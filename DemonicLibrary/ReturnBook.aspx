<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPage1.master" AutoEventWireup="true" CodeBehind="ReturnBook.aspx.cs" Inherits="DemonicLibrary.Return" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
        <table class="auto-style1">
                <tr>
                    <td style="width: 232px"><h3>Returned Book:</h3></td>
                </tr>
                <tr>
            ...
            <tr>
                    <td style="width: 232px">Returned by</td>
                    <td class="auto-style2">
                        <table>
                            <tr>
                                <td Width="300px">
                                ...
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBox5" ErrorMessage="Field cannot be empty."></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                        </table>
                    </td>
